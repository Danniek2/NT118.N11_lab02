...
public class case5 extends Activity {
    ...
    private void initSpnThumbnail()
    {
        ...
        ThumbnailAdapter thumbnailAdapter = new ThumbnailAdapter(case5.this, 1, thumbnails);
    ...
    private void initGvMenu()
    {
        ...
        dishes.add(new Dish("Bún riêu", Thumbnail.Thumbnail1, false));
        dishes.add(new Dish("Cơm tấm", Thumbnail.Thumbnail2, false));

        // Set adapter gridview
        dishAdapter = new DishAdapter(case5.this, R.layout.item_dish, dishes);
    ...
    private void addADish()
    {
        ...
        Toast.makeText(case5.this,getString(R.string.added_successfully), Toast.LENGTH_SHORT).show();
    ...
    private boolean validateData()
    {
        ...
        {
            Toast.makeText(case5.this, getString(R.string.please_enter_a_nane), Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
